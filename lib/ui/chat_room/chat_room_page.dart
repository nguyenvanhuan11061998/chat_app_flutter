                  ...
                  children: [
                    InkWell(
                        ...
                        child: SvgPicture.asset(
                            Assets.icons.icBack, width: 200, height: 20)),
                    ClipRRect(
                  ...
                  children: [
                    Expanded(
                      child: FirebaseAnimatedList(
                        ...
                        return MessageItemWidget(dataMessage: snapshot, keyUserId: keyUserId);
                      }),
                    ),
                            ...
                            InkWell(
                              onTap: () {
                                if (messageController.text.trim().isNotEmpty) {
                                  _roomBloc.sendMessage(messageController.text.trim()).then((value) {
                                    setState(() {
                              ...
                              child: SvgPicture.asset(
                                  Assets.icons.icShare, width: 20, height: 20),
                            ),
                          ],
                        ),
                      ),
